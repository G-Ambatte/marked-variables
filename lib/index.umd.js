(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["marked-variables"] = {}, global.exprEval, global.romans, global.writtenNumber));
	...
	function setMarkedVariable(name, content, page=0) {
		if(page < 0) return;
	...
	function getMarkedVariable(name, page = 0) {
	...
	function setMarkedVariablePage(pageNumber) {
	...
	exports.setMarkedVariablePage = setMarkedVariablePage;
